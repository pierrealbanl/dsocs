...
| `Ctrl + Alt + Shift + E`                    | Recherche une chaîne de texte dans tous les fichiers du projet.                |
...
| `Ctrl + Shift + R`                          | Recherche et remplace du texte dans l’ensemble des fichiers du projet.         |
